...
<label class="underline text-gray-900 dark:text-white">SOF. INCL. COM. JHALMAR EDHEMIR RAMOS CONDORI</label>
                ...
                <label class="underline text-gray-900 dark:text-white">EST. Romero_Salcedo_Jorge_Luiscd</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">Documenthgfhfghgfhfghfghfghation</a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        gfgfgfg v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
            </div>
        </div>
